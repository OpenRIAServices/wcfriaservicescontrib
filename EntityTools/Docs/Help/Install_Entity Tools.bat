...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "RIA Services Contrib Entity Tools" /productName "RIA Services Contrib Entity Tools" > NUL
...
COPY /Y "Entity Tools.msha" HelpContentSetup.msha
